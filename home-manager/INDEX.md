...
- `desktop-apps/INDEX.md` — desktop apps map.
- `editors/INDEX.md` — editors map.
- `shell/INDEX.md` — shells map.
- `tools/INDEX.md` — CLI/TUI tools map.
- `research/INDEX.md` — research/local LLM map.
